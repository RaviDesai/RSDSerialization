...
public struct Content : JSONSerializable {
    ...
    public func convertToJSON() -> JSONDictionary {
        ...
        dict.addTuplesIf(
            ...
            ("artistViewUrl", self.ArtistViewURL.absoluteString),
            ("collectionViewUrl", self.CollectionViewURL.absoluteString),
            ("trackViewUrl", self.TrackViewURL.absoluteString),
            ("previewUrl", self.PreviewURL?.absoluteString),
            ("artworkUrl60", self.ArtworkURL60?.absoluteString),
            ("artworkUrl100", self.ArtworkURL100?.absoluteString),
            ("collectionPrice", self.CollectionPrice),
            ("trackPrice", self.TrackPrice),
            ("collectionExplicitness", self.CollectionExplicitness.rawValue),
            ("trackExplicitness", self.TrackExplicitness.rawValue),
